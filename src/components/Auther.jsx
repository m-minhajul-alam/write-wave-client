    ...
    return (
        <div className="flex flex-col lg:flex-row justify-between items-center max-w-6xl mx-auto">
            ...
            <div className="lg:flex-1 space-y-5 text-center lg:text-left">
                <h1 className="text-5xl font-bold text-primary">We have various <span className="text-secondary">Authors</span> <br /> across the <span className="text-secondary">World</span></h1>
