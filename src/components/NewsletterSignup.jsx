...
const NewsletterSignup = () => {
    ...
    return (
        <div className="md:h-96 flex flex-col md:flex-row items-center justify-between rounded-xl gap-7 my-3 max-w-6xl mx-auto">
            <div className="lg:flex-1 space-y-5 text-center lg:text-right">
                <h1 className="text-2xl md:text-5xl font-bold text-primary">Subscribe to Our <span className="text-secondary">Newsletter</span></h1>
            ...
            <div className="lg:flex-1 bg-gradient-to-tr from-primary to-secondary p-8 rounded-lg shadow-md">
